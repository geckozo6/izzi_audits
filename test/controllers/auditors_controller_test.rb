...
class AuditorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auditor" do
    assert_difference('Auditor.count') do
      post auditors_url, params: { auditor: { bitrthday: @auditor.bitrthday, name: @auditor.name, number: @auditor.number, phone: @auditor.phone } }
    end
  ...
  test "should update auditor" do
    patch auditor_url(@auditor), params: { auditor: { bitrthday: @auditor.bitrthday, name: @auditor.name, number: @auditor.number, phone: @auditor.phone } }
