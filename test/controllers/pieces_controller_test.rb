...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { cmac: @piece.cmac, emac: @piece.emac, failure: @piece.failure, sample_id: @piece.sample_id, serie: @piece.serie, status: @piece.status } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { cmac: @piece.cmac, emac: @piece.emac, failure: @piece.failure, sample_id: @piece.sample_id, serie: @piece.serie, status: @piece.status } }
